...
/**
 * Holds all information about a single participant. These are:
 * <ul>
 * 	<li><strong>SSRC</strong></li>
 ...
 * 	<li>Note</li>
 * 	<li>Information about private extensions</li>
 * </ul>
 * 
...
public class RtpParticipantInfo {
    ...
    // constructors ---------------------------------------------------------------------------------------------------
    /**
     * Creates an object initialized with the given SSRC. <br/>
    ...
    /**
     * Creates an object for which the SSRC is randomly generated.
     */
    ...
    // public methods -------------------------------------------------------------------------------------------------
    /**
     * Modifies this objects attributes by reference to the chunk.
     * 
     * @param chunk {@link SdesChunk} containing the information
     * @return {@code true} if this object was modified, {@code false} otherwise
     */
