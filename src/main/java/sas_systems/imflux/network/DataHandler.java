...
public class DataHandler extends SimpleChannelInboundHandler<DataPacket> {
    ...
    @Override
	protected void channelRead0(ChannelHandlerContext ctx, DataPacket msg)
			throws Exception {
		this.receiver.dataPacketReceived(ctx.channel().localAddress(), msg);
	}
     ...
     */
    //@Override
	protected void messageReceived(ChannelHandlerContext ctx, DataPacket msg)
			throws Exception {
		this.receiver.dataPacketReceived(ctx.channel().localAddress(), msg);
	}
